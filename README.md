...
- `/fabric dashboard` — Activity and phase-grouped Run Flow views, bounded large-flow summaries, per-agent detail with live transcripts, and controls to steer, queue follow-ups, or stop runs.
