...
- `/fabric dashboard` — **Activity** and a parent **Topology** view with **Run** and **Project mesh** children, bounded large-topology summaries, live transcripts, inspectable actors/topics/state/routes, and agent controls.
